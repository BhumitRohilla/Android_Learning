...
public final class FragmentGameBinding implements ViewBinding {
  ...
  private FragmentGameBinding(@NonNull LinearLayout rootView, @NonNull Button btnGuess,
      @NonNull EditText etGuess, @NonNull TextView lives, @NonNull TextView word) {
  ...
  public static FragmentGameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnGuess;
      Button btnGuess = ViewBindings.findChildViewById(rootView, id);
      if (btnGuess == null) {
        break missingId;
      }
      ...
      return new FragmentGameBinding((LinearLayout) rootView, btnGuess, etGuess, lives, word);
    }
